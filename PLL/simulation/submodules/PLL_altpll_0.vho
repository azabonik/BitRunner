...
--synthesis_resources = altpll 1 lut 5 
 ...
 ARCHITECTURE RTL OF PLL_altpll_0 IS
	 ...
	 SIGNAL  wire_pll_altpll_0_altpll_sd1_185_areset	:	STD_LOGIC;
	 SIGNAL  wire_nO_w_lg_pll_altpll_0_prev_reset_20q83w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_pll_altpll_0_altpll_sd1_185_clk	:	STD_LOGIC_VECTOR (5 DOWNTO 0);
	 SIGNAL  wire_pll_altpll_0_altpll_sd1_185_inclk	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 SIGNAL  wire_pll_altpll_0_altpll_sd1_185_locked	:	STD_LOGIC;
 ...
 BEGIN
	...
	wire_w19w(0) <= s_wire_pll_altpll_0_w_select_control_15_dataout AND pll_altpll_0_pfdena_reg_24q;
	wire_w13w(0) <= s_wire_pll_altpll_0_w_select_control_15_dataout AND pll_altpll_0_prev_reset_20q;
	wire_w14w(0) <= s_wire_pll_altpll_0_w_select_status_16_dataout AND pll_altpll_0_pll_altpll_0_stdsync_sv6_stdsync2_pll_altpll_0_dffpipe_l2c_dffpipe3_dffe6a_0_111q;
	...
	wire_w_lg_w19w20w(0) <= wire_w19w(0) OR s_wire_pll_altpll_0_w_select_status_16_dataout;
	wire_w_lg_w13w15w(0) <= wire_w13w(0) OR wire_w14w(0);
	c0 <= wire_pll_altpll_0_altpll_sd1_185_clk(0);
	locked <= wire_pll_altpll_0_altpll_sd1_185_locked;
	phasedone <= '0';
	...
	wire_pll_altpll_0_altpll_sd1_185_areset <= wire_nO_w_lg_pll_altpll_0_prev_reset_20q83w(0);
	wire_nO_w_lg_pll_altpll_0_prev_reset_20q83w(0) <= pll_altpll_0_prev_reset_20q OR areset;
	wire_pll_altpll_0_altpll_sd1_185_inclk <= ( "0" & clk);
	pll_altpll_0_altpll_sd1_185 :  altpll
	  GENERIC MAP (
		BANDWIDTH => 0,
		BANDWIDTH_TYPE => "AUTO",
		C0_HIGH => 0,
	  ...
	  PORT MAP ( 
		areset => wire_pll_altpll_0_altpll_sd1_185_areset,
		clk => wire_pll_altpll_0_altpll_sd1_185_clk,
		inclk => wire_pll_altpll_0_altpll_sd1_185_inclk,
		locked => wire_pll_altpll_0_altpll_sd1_185_locked
	  );
	PROCESS (clk, reset)
	BEGIN
	...
	BEGIN
		...
		ELSIF (clk = '1' AND clk'event) THEN
				pll_altpll_0_pll_altpll_0_stdsync_sv6_stdsync2_pll_altpll_0_dffpipe_l2c_dffpipe3_dffe4a_0_107q <= wire_pll_altpll_0_altpll_sd1_185_locked;
