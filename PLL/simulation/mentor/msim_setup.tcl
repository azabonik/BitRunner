...
# ACDS 13.0sp1 232 win32 2014.12.07.17:23:40
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altpll_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altpll_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
